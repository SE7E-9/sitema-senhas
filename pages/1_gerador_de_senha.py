...
senha_manual = st.text_input("Digite a senha manual (ou deixe vazio para gerar automática):", key="senha_manual")
...
if st.button("Gerar senha"):
    if st.session_state.senha_manual.strip():
        nova_senha = st.session_state.senha_manual.strip()
    else:
    ...
    # Limpa o campo de senha manual após gerar
